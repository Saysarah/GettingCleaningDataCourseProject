...
final_df <- finalData
file <- "~/CleanData/UCI HAR Dataset/test.txt"
...
step4_df <- meanSdData
file <- "~/CleanData/UCI HAR Dataset/test2.txt" ##step4_df.txt"
write.csv(step4_df, file = file, row.names=FALSE) ##sep="\t", quote=FALSE)
